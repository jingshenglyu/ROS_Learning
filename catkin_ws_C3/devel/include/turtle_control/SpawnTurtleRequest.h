...
bool operator==(const ::turtle_control::SpawnTurtleRequest_<ContainerAllocator1> & lhs, const ::turtle_control::SpawnTurtleRequest_<ContainerAllocator2> & rhs)
{
  return lhs.tur_name == rhs.tur_name &&
    lhs.pose_x == rhs.pose_x &&
    lhs.pose_y == rhs.pose_y &&
    lhs.tur_theta == rhs.tur_theta;
}
