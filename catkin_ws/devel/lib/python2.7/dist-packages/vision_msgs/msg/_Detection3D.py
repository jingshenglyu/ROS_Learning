...
class Detection3D(genpy.Message):
  _md5sum = "d570bbfcd5dea29f64da78e043da65ae"
...
"""
  __slots__ = ['header','results','bbox','source_cloud','is_tracking','tracking_id']
  _slot_types = ['std_msgs/Header','vision_msgs/ObjectHypothesisWithPose[]','vision_msgs/BoundingBox3D','sensor_msgs/PointCloud2','bool','string']
