...
class Detection2DArray(genpy.Message):
  _md5sum = "5f62729a3134356dd48cf97c678c6753"
      ...
      for val1 in self.detections:
        ...
        for val2 in val1.results:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.pack('<I%ss'%length, length, _x))
          buff.write(_get_struct_d().pack(val2.score))
          _v3 = val2.pose
          _v4 = _v3.pose
          _v5 = _v4.position
          _x = _v5
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_B().pack(val1.is_tracking))
        _x = val1.tracking_id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v20.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.tracking_id = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v42.encoding = str[start:end].decode('utf-8')
        else:
