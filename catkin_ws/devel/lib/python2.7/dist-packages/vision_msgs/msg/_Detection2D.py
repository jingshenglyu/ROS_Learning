...
class Detection2D(genpy.Message):
  _md5sum = "e38d1866e74825fff6b9ec7ca5865dc2"
...
"""
  __slots__ = ['header','results','bbox','source_img','is_tracking','tracking_id']
  _slot_types = ['std_msgs/Header','vision_msgs/ObjectHypothesisWithPose[]','vision_msgs/BoundingBox2D','sensor_msgs/Image','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,results,bbox,source_img,is_tracking,tracking_id
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.is_tracking))
      _x = self.tracking_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.is_tracking,) = _get_struct_B().unpack(str[start:end])
      ...
      if python3:
        self.tracking_id = str[start:end].decode('utf-8')
      else:
