...
"""autogenerated by genpy from move_base_msgs/MoveBaseActionResult.msg. Do not edit."""
import sys
...
class MoveBaseActionResult(genpy.Message):
  ...
  _type = "move_base_msgs/MoveBaseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','move_base_msgs/MoveBaseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = move_base_msgs.msg.MoveBaseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = move_base_msgs.msg.MoveBaseResult()
