...
get_filename_component(_filename "/home/jingsheng/ROS_Learning/catkin_ws/src/turtle_control/srv/SpawnTurtle.srv" NAME_WE)
add_custom_target(_turtle_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "turtle_control" "/home/jingsheng/ROS_Learning/catkin_ws/src/turtle_control/srv/SpawnTurtle.srv" ""
)
...
_generate_srv_cpp(turtle_control
  "/home/jingsheng/ROS_Learning/catkin_ws/src/turtle_control/srv/SpawnTurtle.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/turtle_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/turtle_control\")")
  # install generated code
  install(
